...
throughput changes (the Y axis). Below is the roofline model generated on a 
mid-2012 Macbook Pro.

\includegraphics{roofline1}
...
Below we present the roofline model generated using the same operation as above 
but comparing the hand-tuned SIMD implementation to our auto-generated SIMD
implementation.

\includegraphcis{roofline2}
